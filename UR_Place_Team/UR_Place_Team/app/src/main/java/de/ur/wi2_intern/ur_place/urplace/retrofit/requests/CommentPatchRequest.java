...
public class CommentPatchRequest {
    ...
    public CommentPatchRequest(int id, int post, String text, String picture, GPS gps, ArrayList<CommentLike> likes, Profile profile, String dateCreated, String lastUpdated) {
        this.id = id;
        this.post = post;
        this.text = text;
