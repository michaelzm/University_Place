...
public class ProfileMePatchRequest {
    public int id;
    ...
    public ProfileMePatchRequest(int id, Gender gender, String subject, String nickname, String firstname, String lastname, ArrayList<Hobby> hobbies, String birthdate, String profilePicture) {
        this.id = id;
        this.gender = gender;
