...
public class MessagesActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle(getString(R.string.te_menu_messages));
    ...
    public void fillConversationList(){
        listView = (ListView)findViewById(R.id.listView_conversations);
        getConversations();

       // for(int i = 0;i<cList.size();i++){
        //    adapter.add(cList.get(i));
        //}

        adapter = new ConversationAdapter(getApplicationContext(),R.layout.list_item_user_search);
