...
public class ArticleIdPutRequest {
    public int id;
    public String title;
    ...
    public ArticleIdPutRequest(int id, String title, String description, ArrayList<ArticleCategory> articleCategories, ArticleType articleType, String inShopUntil, double price, String picture, ArticleContactData articleContactData, String dateCreated, String lastUpdated) {
        this.id = id;
        this.title = title;
