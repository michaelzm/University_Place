...
public class PostPatchRequest {
    ...
    public PostPatchRequest(int id, String text, String picture, ArrayList<Comment> comments, ArrayList<PostLike> likes, Profile profile, GPS gps, String dateCreated, String lastUpdated) {
        this.id = id;
        this.text = text;
